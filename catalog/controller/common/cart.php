...
class Cart extends \Opencart\System\Engine\Controller {
	...
	public function index(): string {
		...
		$data['text_items'] = $this->cart->countProducts();//sprintf($this->language->get('text_items'), $this->cart->countProducts(), $this->currency->format($total, $this->session->data['currency']));
	...
	public function content(): string {
		...
		return $this->load->view('common/cartcontent', $data);
	}
	...
	public function remove(): void {
		file_put_contents(DIR_LOGS . 'cart_remove.log', 'REMOVE hit with key: ' . ($this->request->post['key'] ?? 'none') . PHP_EOL, FILE_APPEND);
